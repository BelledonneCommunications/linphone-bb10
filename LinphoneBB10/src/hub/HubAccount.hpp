...
public Q_SLOTS:
     ...
     */
    bool addHubItem(qint64 categoryId, QVariantMap &itemMap, QString name, QString subject, qint64 timestamp, QString itemSyncId, QString itemUserData, QString itemExtendedData, QString icon, bool read, bool notify);
...
protected:
	...
	QString _itemCallMimeType;

    QString _itemMessageMimeType;
	QString _itemMessageReadIconFilename;
	QString _itemMessageUnreadIconFilename;
};
