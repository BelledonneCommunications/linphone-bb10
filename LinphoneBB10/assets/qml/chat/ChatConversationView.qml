...
Container {
    ...
    Container {
        ...
        TopBarButton {
            visible: !chatListModel.chatModel.isNewConversation && !chatListModel.chatModel.editor.isEditMode && !inCallModel.isInCall
        ...
        TopBarButton {
            visible: inCallModel.isInCall && !chatListModel.chatModel.editor.isEditMode 
